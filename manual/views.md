...
![](images/class-hierarchy-view.png)
...
![](images/class-hierarchy-open.png)
...
|                               | Command                    | Description
|:-----------------------------:|----------------------------|------------
![](icons/hierarchy_co.png)     | Class Hierarchy            | Displays all superclasses and subclasses.
![](icons/super_co.png)         | Superclass Hierarchy       | Displays all superclasses and implemented interface classes.
![](icons/sub_co.png)           | Subclass Hierarchy         | Displays all subclasses that extend or implement the selected (interface) class.
![](icons/th_showqualified.png) | Show Qualified Class Names | Shows the qualified name next to each class.
...
|                                   | Command                | Description
|:---------------------------------:|------------------------|------------
![](icons/inher_co.png)             | Show Inherited Members | Shows or hides all members inherited from superclasses.
![](icons/definingtype_sort_co.png) | Sort By Defining Class | Sorts members by the class in which they are defined.
![](icons/fields_co.png)            | Hide Fields            | Hides all fields in the members list.
