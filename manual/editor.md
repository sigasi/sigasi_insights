...
## Initial proprocessor definitions for (System)Verilog projects
...
The code in the **Initial preprocessor definitions** field is preprocessed before all other (System)Verilog code in your project. This allows you to, for example, set global defines without and explicit `include` statement.
