...
|                            | [Empty parameters]({{< ref "rules/verilog_empty_parameters" >}})                                                                                                | 53, 54 |
...
|                            | [Incorect port declaration]({{< ref "rules/verilog_incorrect_port_declaration" >}})                                                                             | 135-139 |
|                            | [Empty port in ANSI port list]({{< ref "rules/verilog_empty_ansi_port" >}})                                                                                     | 141 |
...
| {{< severity warning 1 >}} | [Disallow `reg` datatype]({{< ref "rules/verilog_reg" >}})                                                                                                      |  3 |
...
|                            | [Implicit net]({{< ref "rules/verilog_implicit_net/" >}})                                                                                                       | 97 |
|                            | [Duplicate conditions]({{< ref "rules/verilog_duplicate_conditions" >}})                                                                                        | 98 |
|                            | [Upward reference]({{< ref "rules/upward_reference/" >}})                                                                                                       | 99 |
|                            | [Duplicate continuous assignments]({{< ref "rules/verilog_duplicate_continuous_assignments" >}})                                                                | 101 |
|                            | [Whitespace following a backtick]({{< ref "rules/verilog_tool_compatibility/#whitespace-following-a-backtick" >}})                                              | 117 |
|                            | [Invalid preprocessor syntax]({{< ref "rules/verilog_tool_compatibility/#invalid-preprocessor-syntax-outside-macro-body" >}})                                   | 121 |
|                            | [Unused macros]({{< ref "rules/verilog_unused_macros" >}})                                                                                                      | 128 |
|                            | [Unused declaration]({{< ref "rules/verilog_unused_declaration" >}})                                                                                            | 130 |
|                            | [Type checking]({{< ref "rules/verilog_type_checking" >}})                                                                                                      | 78, 79, 94, 100, 131 |
|                            | [Hidden non-virtual methods]({{< ref "rules/verilog_hiding_non_virtual_methods" >}})                                                                            | 132 |
|                            | [Unexpected empty concatenation]({{< ref "rules/verilog_empty_concatenation" >}})                                                                               | 133 |
|                            | [Unexpected empty assignment pattern]({{< ref "rules/verilog_empty_assignment_pattern" >}})                                                                     | 134 |
|                            | [Duplicate port]({{< ref "rules/verilog_duplicate_port" >}})                                                                                                    | 140 |
|                            | [Empty port]({{< ref "rules/verilog_empty_non_ansi_port" >}})                                                                                                   | 142 |
