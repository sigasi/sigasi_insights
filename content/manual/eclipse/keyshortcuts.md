...
1. Structured Select (**Shift+Alt+Up/Down/Left/Right**)  
  Select VHDL or Verilog code, based on its *syntactic structure*. ([Structured selection]({{< ref "/manual/eclipse/editor.md#structured-selection" >}}))  
...
If you're looking for Vi or Emacs keybindings, have a look at {{< page "manual/eclipse/plugins" >}}.
