...
The custom installation is documented in a [separate section](/manual/eclipse/custom-setup).
...
More details can be found [here](/manual/eclipse/license-key). The license unlocks the features for your [edition](/manual/common/editions).
