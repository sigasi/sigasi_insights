...
The syntax for a ConfigurationItem is as follows: `hide | collapse | color GraphicsColor`. You can discover which colors are available [here]({{< ref "graphics.ebnf#GraphicsColor" >}}) or through autocomplete.
