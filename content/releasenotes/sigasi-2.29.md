...
You can now configure Cadence Incisive (NCSim) as [Save-time compilation](/manual/eclipse/tools#save-time-compilation) for your HDL code. Once configured, Sigasi will automatically run `ncvhdl` and `ncvlog` to compile your code. All issues will get a problem marker in the editor and will appear in the problems view. 
